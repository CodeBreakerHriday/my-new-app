...
const [readingcount,setcount] = useState(0);
  ...
  <div className=''>
  <h1 className='bg-gray-[#6047EC1A] mr-10 md:mr-0 mb-6 w-[360px] md:w-[411px] border-blue-400 text-[#6047EC] font-bold text-xl border-2 p-8 rounded-lg max-w-[411px] '>Spent time on read : {sum} min</h1>
